...
APP_DIR="${APP_DIR:-/opt/sandalphone}"
...
write_env() {
  ...
  set_env_key "${env_path}" "GOOGLE_CLOUD_API_KEY" "${GOOGLE_CLOUD_API_KEY}"
  set_env_key "${env_path}" "GOOGLE_TTS_VOICE_EN" "${GOOGLE_TTS_VOICE_EN}"
  set_env_key "${env_path}" "GOOGLE_TTS_VOICE_ES" "${GOOGLE_TTS_VOICE_ES}"
