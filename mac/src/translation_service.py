...
class TranslationService:
    ...
    def translate_audio(self, input_audio, source_lang="es", target_lang="en", output_audio=None):
        """
        ...
        output_audio_path = self.tts.synthesize(translation, output_audio, language=target_lang)
